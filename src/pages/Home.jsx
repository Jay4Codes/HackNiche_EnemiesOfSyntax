...
import feature1 from "../assets/images/speech.png";
import feature2 from "../assets/images/bridge.png";
import feature3 from "../assets/images/awareness.png";
import bannermock from "../assets/images/mockup1.png";
              ...
              <div className="col-lg-6 mb-5 mb-lg-0">
                <div className="block text-center text-lg-start pe-0 pe-xl-5">
                  <h1 className="text-capitalize mb-4">
                    Keeping you updated with the latest news from your
                    neighborhood
                  </h1>
                  <p className="mb-4">
                    hyperlocal news video-sharing app, which empowers digital
                    journalism in India, and provides the user with the latest
                    and important local news updates.
                  </p>
                ...
                <div className="col-lg-5">
                  <div className="section-title">
                    ...
                    <div className="content mb-0 mt-4">
                      <p>
                        CitJo - A unique platform that brings local journalists
                        & regional media houses onto the same platform as the
                        local residents to deliver real and raw news.
                      </p>
                      <p>
                        CitJo believes that journalism is not what is being
                        reported while sitting in a fancy studio or hosting
                        TRP-focused news debates. Building a platform for local
                        journalists & regional media houses where they will be
                        putting forward raw, unbiased & real news videos which
                        will be directly shown to the people of the respective
                        region.
                      </p>
                    </div>
                  </div>
                ...
                <div className="col-lg-6">
                  <div className="difference-of-us-item p-3 rounded mr-0 me-lg-4">
                    <div className="d-block d-sm-flex align-items-center m-2">
                      ...
                      <div className="block">
                        <h3 className="mb-3">Open platform</h3>
                        <p className="mb-0">
                          Citjo is an open platform with no upfront cost to use,
                          and distribute.
                        </p>
                      </div>
                    </div>
                  ...
                  <div className="difference-of-us-item p-3 rounded mr-0 me-lg-4">
                    <div className="d-block d-sm-flex align-items-center m-2">
                      ...
                      <div className="block">
                        <h3 className="mb-3">Real-time local news</h3>
                        <p className="mb-0">
                  ...
                  <div className="difference-of-us-item p-3 rounded mr-0 me-lg-4">
                    <div className="d-block d-sm-flex align-items-center m-2">
                      ...
                      <div className="block">
                        <h3 className="mb-3">Multilingual</h3>
                        <p className="mb-0">
        ...
        <div className="section container">
          <Fade bottom cascade>
            <div className="row justify-content-center bg-black">
              ...
              <div className="col-lg-10 bg-black">
                <ul
                ...
                >
                  <li className="nav-item m-2" role="presentation">
                    <Link
                      className="nav-link btn btn-outline-primary effect-none active"
                  ...
                  <li className="nav-item m-2" role="presentation">
                    <Link
                      className="nav-link btn btn-outline-primary effect-none"
                ...
                <div
                  className="rounded shadow bg-black p-5 tab-content"
                  id="pills-tabContent"
                >
                  <div
                    ...
                    <div className="row align-items-center">
                      <div className="col-md-6 order-1 order-md-0">
                        <div className="content-block">
                          <h3 className="mb-4">FREEDOM OF SPEECH</h3>
                          <div className="content">
                            <p>
                              Our mission is to raise the voices of small and
                              rural citizens who have been muted by metropolitan
                              media titans who frequently support questionable
                              subjects because they have political power.
                            </p>
                          </div>
                        </div>
                      </div>
                  ...
                  >
                    <div className="row align-items-center">
                      <div className="col-md-6 order-1 order-md-0">
                        <div className="content-block">
                          <h3 className="mb-4">BRIDGING THE GAP</h3>
                          <div className="content">
                            <p>
                              Bringing people and their issues closer to
                  ...
                  >
                    <div className="row align-items-center">
                      <div className="col-md-6 order-1 order-md-0">
                        <div className="content-block">
                          <h3 className="mb-4">AWARENESS BUILDING</h3>
                          <div className="content">
                            <p>
                              We are working to create a platform that will
                              enable people to learn about and raise awareness
                              for issues that have a national impact.
                            </p>
                          </div>
                        </div>
                      </div>
